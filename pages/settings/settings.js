...
Page({
    ...
    settingGroups: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'canvas', name: '曲线', icon: 'canvas' },
          { id: 'geo-map', name: '地图画圈', icon: 'geo-map' },
          { id: 'calendar', name: '日历显示', icon: 'calender' },
  ...
  goToGeoMap() {
    wx.navigateTo({
      url: '/pages/geomap_tst/geomap_tst',
    })
  },
  ...
  goToValueCalendar() {
    wx.navigateTo({
      url: '/pages/value-calendar-test/value-calendar-test',
    })
  }
})
